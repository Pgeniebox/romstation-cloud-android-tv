...
/* JADX INFO: loaded from: RomStation.jar:org/romstation/application/database/entity/EmulatorFile.class */
@Table(name = "EMULATOR_FILE")
@Entity
@Access(AccessType.PROPERTY)
@NamedQueries({@NamedQuery(name = EmulatorFile.f423a, query = "select emulatorFile from EmulatorFile emulatorFile where emulatorFile.rid = :rid")})
public class EmulatorFile extends RemoteEntity {

    /* JADX INFO: renamed from: a */
    public static final String f423a = "EmulatorFile.findByRID";
    ...
    private Emulator f427e;

    /* JADX INFO: renamed from: f */
    private List<EmulatorProfile> f428f = new LinkedList();

    /* JADX INFO: renamed from: g */
    private List<Script> f429g = new LinkedList();

    /* JADX INFO: renamed from: h */
    private Map<String, String> f430h = new HashMap();
    ...
    public EmulatorFile(EmulatorFile entity) {
        ...
        this.f424b = entity.getName();
        this.f425c = entity.getDirectory();
        this.f427e = entity.getEmulator();
        this.f426d = false;
        entity.getProfiles().forEach(emulatorProfile -> {
            this.f428f.add(new EmulatorProfile(emulatorProfile));
        });
        this.f429g.addAll(entity.getScripts());
        this.f430h.putAll(entity.getMetas());
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: ModVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't change immutable type java.lang.Object to org.romstation.application.database.entity.EmulatorFile for r5v1 'this'  java.lang.Object
    ...
    private void prePersist() {
        ...
        L4f:
            ...
            org.romstation.application.script.api.database.adapter.EmulatorFileAdapter r0 = r0.emulator_file
        ...
        L70:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.romstation.application.database.entity.EmulatorFile.prePersist():void");
    }
    ...
    private void postPersist() {
        ...
        L70:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.romstation.application.database.entity.EmulatorFile.postPersist():void");
    }
    ...
    private void preUpdate() {
        ...
        L70:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.romstation.application.database.entity.EmulatorFile.preUpdate():void");
    }
    ...
    private void postUpdate() {
        ...
        L70:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.romstation.application.database.entity.EmulatorFile.postUpdate():void");
    }
    ...
    private void preRemove() {
        ...
        L70:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.romstation.application.database.entity.EmulatorFile.preRemove():void");
    }
    ...
    private void postRemove() {
        ...
        L70:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.romstation.application.database.entity.EmulatorFile.postRemove():void");
    }
