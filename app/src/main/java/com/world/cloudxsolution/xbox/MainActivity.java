...
import com.world.cloudxsolution.IStreamingService;
import com.world.cloudxsolution.xbox.NativePcmPlayer;
import com.world.cloudxsolution.R;
import com.world.cloudxsolution.xbox.StickTestView;
import com.world.cloudxsolution.xbox.StreamingService;
import com.world.cloudxsolution.xbox.WebRtcBridge;
...
public class MainActivity extends AppCompatActivity {
    ...
    private NativePcmPlayer nativePcmPlayer;
    private WebMessagePortCompat[] audioPorts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //nativePcmPlayer = new NativePcmPlayer();
        WebView.enableSlowWholeDocumentDraw();
        SplashScreen splashScreen = SplashScreen.installSplashScreen(this);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_xbox);
...
// Request unbuffered dispatch specifically for joystick input sources
    ...
    private void initWebView() {
        ...
        // Optimization: Prepare content before it comes on screen
...
//
// Allow the HTML to load other files from the assets folder
        webSettings.setAllowFileAccess(true);
        webSettings.setAllowContentAccess(true);

// Critical if your HTML uses Ajax or loads sub-resources from assets
        ...
        String uaKey = prefs.getString(KEY_USER_AGENT, "tizen");
...
//
//                // Do NOT block anything if we are on a login or authentication page
//                if (pageUrl != null && (pageUrl.contains("login.live.com") ||
//                    pageUrl.contains("login.microsoftonline.com") ||
//                    pageUrl.contains("account.microsoft.com"))) {
//                    return super.shouldInterceptRequest(view, request);
//                }
//
//                // Block heavy telemetry and tracking to save CPU/Network on TV for Xbox domains
//                if (url.contains("vortex.data.microsoft.com") ||
//                    url.contains("google-analytics.com") ||
//                    url.contains("telemetry") ||
//                    url.contains("omni.skype.com")) {
...
//            }
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                // Only apply xCloud-specific patches if we are on an Xbox domain
                if (url != null && url.contains("xbox.com")&&!url.contains("msn")&&!url.contains("microsoft")&&url.contains("play")) {
        ...
        WebRtcBridge bridge = new WebRtcBridge(this, null);
    ...
    private void initAudioPipe() {
        if (WebViewFeature.isFeatureSupported(WebViewFeature.CREATE_WEB_MESSAGE_CHANNEL)) {
            audioPorts = WebViewCompat.createWebMessageChannel(webView);
            audioPorts[0].setWebMessageCallback(new WebMessagePortCompat.WebMessageCallbackCompat() {
                @Override
                public void onMessage(@NonNull WebMessagePortCompat port, @Nullable WebMessageCompat message) {
                    if (message != null && message.getType() == WebMessageCompat.TYPE_ARRAY_BUFFER) {
                        byte[] data = message.getArrayBuffer();
                        if (nativePcmPlayer != null && data != null) {
                            nativePcmPlayer.play(data);
                        }
                    }
                }
            });
    ...
    private void transferAudioPort() {
        if (audioPorts != null && audioPorts.length > 1 && 
            WebViewFeature.isFeatureSupported(WebViewFeature.POST_WEB_MESSAGE)) {
            try {
                WebViewCompat.postWebMessage(webView, 
                    new WebMessageCompat("INIT_AUDIO_PIPE", new WebMessagePortCompat[]{audioPorts[1]}), 
                    Uri.parse("https://www.xbox.com"));
                Log.i(TAG, "Audio port transferred to WebView");
            } catch (Exception e) {
                Log.e(TAG, "Failed to transfer audio port", e);
            }
        }
    }
...
//                    webView.loadUrl("file:///android_asset/stream/index.html");
...
//            }
    ...
    protected void onDestroy() {
        if (nativePcmPlayer != null) {
            nativePcmPlayer.release();
            nativePcmPlayer = null;
        }
    ...
    private class CustomWebChromeClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            ...
            if(!isScriptInjected&&newProgress > 35  ) {
    ...
    public void showStreamingMenuDialog() {
        ...
        Button btnClear = dialog.findViewById(R.id.btn_clearCache);
        ...
        btnClear.setOnClickListener(v->{
            if(webView!=null){
                ...
                webView.onPause();
                webView.clearCache(true);
                getApplication().onTrimMemory(TRIM_MEMORY_BACKGROUND);
                webView.reload();
            }
        });
