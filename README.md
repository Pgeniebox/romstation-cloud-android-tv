...
CloudX is a high-performance, open-source Android application designed to provide a native, low-latency cloud gaming experience for both **Xbox Cloud Gaming** and **RomStation**. 
...
1. **Lightweight Selection**: We use WebViews only for the login and game selection process (for both Xbox and RomStation).
...
### 🎮 Unified Entry Point
- **Launcher Selection**: A dedicated selection screen allows you to choose between Romstation and Xbox modes at startup.
...
- A valid subscription for the respective service (Xbox Game Pass Ultimate or RomStation).
...
*Disclaimer: This project is not affiliated with, endorsed by, or sponsored by Microsoft, Xbox, or RomStation.*
